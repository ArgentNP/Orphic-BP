...
execute @s[tag=hermes_perk,tag=hermes_ready] ~ ~ ~ replaceitem entity @s slot.armor.chest 0 elytra 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
...
execute @s[tag=hermes_perk,tag=hermes_ready] ~ ~ ~ scoreboard players set @s playerPower 0
...
execute @s[tag=hermes_perk,tag=hermes_sub] ~ ~ ~ scoreboard players set @s playerPower 0
