...
execute @a[tag=!staffMode,tag=is_sneaking,tag=!agility_perk,scores={playerPower=..99}] ~ ~ ~ execute @s[scores={playerPerk=!7}] ~ ~ ~ execute @s[scores={playerPerk=1..}] ~ ~ ~  scoreboard players add @s playerPower 1
execute @a[tag=!staffMode,tag=is_sneaking,tag=!agility_perk,scores={playerPower=..99}] ~ ~ ~ execute @s[scores={playerPerk=!7}] ~ ~ ~ execute @s[scores={playerPerk=3}] ~ ~ ~ scoreboard players add @s playerPower 1
